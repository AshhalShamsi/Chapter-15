...
*/
public class ToDo1 implements Comparable
{
   ...
   */
   ...
   public ToDo1(String priority, String description)
   {
        ...
        if(this.priority.charAt(0) == 'M')
        ...
        else if (this.priority.charAt(0) == 'D')
            {
                if(Integer.parseInt(other.priority) < 2)
                    return 1;
                else if(Integer.parseInt(other.priority) > 1)
                    return -1;
            }
        else if(this.priority.charAt(0) == 'W')
            {
                 if(Integer.parseInt(other.priority) < 3)
                    return 1;
        ...
        if(other.priority.charAt(0) == 'M')
        ...
        else if (other.priority.charAt(0) == 'D')
            {
                if(Integer.parseInt(this.priority) < 2)
                    return -1;
                else if(Integer.parseInt(this.priority) > 1)
                    return 1;
            }
        else if(other.priority.charAt(0) == 'W')
            {
                if(Integer.parseInt(this.priority) < 3)
                    return -1;
